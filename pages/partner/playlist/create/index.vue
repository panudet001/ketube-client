...
const menu = [
  ...
  { menu: "Create Playlist", link: "/partner/playlist/create" },
];
...
const onSubmit = handleSubmit(async (value) => {
  ...
  if (
    ...
    await playlistPartnerStore.createPlaylist(formData);
    if (playlistPartnerStore.error) {
      ...
      navigateTo("/partner/playlist/success");
      isLoading.value = false;
    }
  }
});
...
<template>
  <div class="create-playlist-partner-page">
    <div class="wrapper-content">
      ...
      <div class="section-form">
        ...
        <form class="" @submit="onSubmit">
          <p class="title-playlist">สร้างเพลย์ลิสต์</p>
          <hr />
          <div class="row">
            <!-- Step Desktop -->
            <div class="step-desktop col-md-4">
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <p class="font-body-2">เพิ่มข้อมูล</p>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <p class="font-body-2">เพิ่มเพลง</p>
                </div>
              </div>
            </div>
            ...
            <div class="table-desktop col-md-8">
              <div v-if="step === 1">
                <div class="mb-3">
                  <label for="files" class="form-label title-cover-playlist"
                    >รูปเพลย์ลิสต์ <span class="text-danger">*</span></label
                  >
                  <div class="input-file-groups-thumbnail">
                    ...
                    <p v-if="isPhotoThumbnail" class="text-danger">
                      กรุณาเลือกรูปภาพ Thumbnail
                    </p>
                  </div>
                </div>
                <div class="mb-3">
                  <label for="files" class="form-label title-cover-playlist"
                    >ภาพปกเพลย์ลิสต์ <span class="text-danger">*</span></label
                  >
              ...
              <div v-if="step === 2" class="step-2">
                ...
                <VideoPlaylistModal
                  ...
                  :video="video"
                  :initial-video-name="initialVideoListValue"
                ></VideoPlaylistModal>
...
<style
  src="assets/scss/pages/partner/playlist/create-playlist-partner.scss"
  lang="scss"
  scoped
></style>

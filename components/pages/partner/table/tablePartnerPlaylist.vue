...
<template>
  <div class="table-playlist-component">
      ...
      <table class="data-table">
        ...
        <tbody v-if="dataStore.length > 0">
          <tr v-for="(val, index) in dataStore" :key="index">
            ...
            <td>
              <div class="card-image">
                <img
                  ...
                  alt=""
                />
                <NuxtLink class="text-link" :to="link + val.id">{{
                  val.name
                }}</NuxtLink>
              </div>
            </td>
            ...
            <td>
              {{ val.updatedBy.firstname ? val.updatedBy.firstname : "-" }}
            </td>
            <td>
              <StatusPartnerCard
            ...
            <td class="d-none">
              <i class="las la-eye icon me-2"></i
        ...
        >
          ...
          <NuxtLink :to="link + val.id" class="text-start">
            <div class="card-item">
              ...
              <p class="font-body-3">{{ val.units }} songs</p>
...
<style
  src="/components/pages/partner/table/tablePartnerPlaylist.scss"
  lang="scss"
  scoped
></style>

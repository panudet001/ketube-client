...
const crop = async () => {
  ...
  if (croppedResult.image) {
    const {
      ...
      fileSizeMB,
    } = await resizeImage(croppedResult.image, 200, 225);
...
<template>
  <div class="preview-image-thumbnail-modal">
    <div
      id="previewImageThumbnailModal"
      class="modal fade"
      tabindex="-1"
...
<style
  src="/components/modal/preview/PreviewImageThumbnail.scss"
  lang="scss"
  scoped
></style>
